...
CMD ["bash", "-c", "curl -fsSL https://raw.githubusercontent.com/brbbbq/bfgf-school-comfy/main/start.sh -o /workspace/ComfyUI/start.sh && chmod +x /workspace/ComfyUI/start.sh && /workspace/ComfyUI/start.sh"]